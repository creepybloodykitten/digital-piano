...
module lpddr2_qsys_mem_if_lpddr2_emif_0_p0_new_io_pads(
...
wire afi_rdata_en_full_shifted = afi_rdata_en_full_shifted_int;
	...
	lpddr2_qsys_mem_if_lpddr2_emif_0_p0_addr_cmd_pads uaddr_cmd_pads(
	...
	wire [1:0] vfifo_inc_wr_ptr = {1'b0,seq_read_increment_vfifo_fr[i]};
			...
			lpddr2_qsys_mem_if_lpddr2_emif_0_p0_altdqdqs ubidir_dq_dqs (
